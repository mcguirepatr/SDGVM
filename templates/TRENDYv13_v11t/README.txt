Notes:  
  The version numbers below refer to:
      ...
      v8y15 = code version number for the current version of SDGVM FORTRAN code
      v9e  = template installation version number from TRENDYv12 to copy from 
      v11c = installation version number to copy from 
      v11t = installation version number to copy to 
...
#Steps required to install and run the code on JASMIN:
 ...
 #into the following directory:
  /gws/ssde/j25a/nexcs/pmcguire/TRENDYv10/sdgvm_v8y15_debug/

 #open a screen session & rsync the db:
   screen
   rsync -auh --info=progress2 /gws/ssde/j25a/nexcs/pmcguire/TRENDYv13/db/ /work/scratch-pw5/pmcguire/TRENDYv13/db/
 ...
 #These files have already been downloaded and processed for 2024, and are available in /gws/ssde/j25a/nexcs/pmcguire/TRENDYv13/db/
      cd /gws/ssde/j25a/nexcs/pmcguire/TRENDYv13/db/landcover/hyde/LUH2/v2h_2024/
 ...
 #  The 2024 copy of the preprocessed data is found here:
    /gws/ssde/j25a/nexcs/pmcguire/TRENDYv13/db/clim/global/crujra_2024/30min
 #The preprocessing scripts are found here:
  cd /gws/ssde/j25a/nexcs/pmcguire/TRENDYv10/sdgvm_v8y15_debug/tools/reformat/
 ...
 #compile the SDGVM FORTRAN code:
  cd /gws/ssde/j25a/nexcs/pmcguire/TRENDYv10/sdgvm_v8y15_debug/
 ...
 ./create_runs.scr #create the TRENDYv12 runs in the (spin_accel,spin_accelFS,spin_accel0,,S0,S1,S2,S3,S5,S6,FS4,FS5) dirs
 ./modify_runs.scr #update the runs for TRENDYv13

 #Copy the runs to the much faster scratch-pw5 HDD & run them:
 cp -pr ../TRENDYv13_v11t/  /work/scratch-pw5/pmcguire/sdgvmR/.
 cd /work/scratch-pw5/pmcguire/sdgvmR/TRENDYv13_v11t/
 ./run_runs.scr
 ...
 #repeat for the other runs (S0,S1,S2,S5,S6,FS4,FS5,spin_accel,spin_accelFS,spin_accel0)

 #run the results plotting script to compare runs
 cd /work/scratch-pw5/pmcguire/sdgvmR/TRENDYv13_v11t/results
 screen 
