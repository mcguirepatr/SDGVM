...
*----------------------------------------------------------------------*
     ...
     &sttxdp,lat,lon,soil_chr,soil_chr2,du,l_soil,soilCtoN,soilp)
      ...
      REAL*8 wilt,field,sat,dep,soilCtoN,soilp
      INTEGER du
      ...
      !currently these variables are only read from the soil database but could be added to the input.dat file 
...
*                          *************************                   *
*----------------------------------------------------------------------*
      SUBROUTINE OUTPUT_OPTIONS(otags,omav,ofmt)
*----------------------------------------------------------------------*
      IMPLICIT NONE
      INCLUDE 'array_dims.inc'

      INTEGER omav(douts)
      CHARACTER otags(douts)*1000,ofmt(200)*100
...
*----------------------------------------------------------------------*
      ...
      ofmt(25)  ='(i4,1x,12f10.2,f10.2)'
      ofmt(26)  ='(i4,1x,12f10.2,f10.2)'
      ofmt(27)  ='(i4,1x,12f10.2,f10.2)'
      ofmt(28)  ='(i4,1x,12f10.2,f10.2)'
      ...
      ofmt(35:100)  ='(i4,1x,12(f10.2,1x),f10.2)'

*----------------------------------------------------------------------*
* Daily output format.                                                 *
*----------------------------------------------------------------------*
      ofmt(101:200)  ='(31(f9.3,1x))'
...
*                          ************************                    *
*----------------------------------------------------------------------*
      SUBROUTINE SET_PIXEL_OUT(st1,st2,outyears,otagsn,otags,
     &oymd)
*----------------------------------------------------------------------*
      IMPLICIT NONE
      INCLUDE 'array_dims.inc'

      INTEGER otagsn(douts),i,j,ii,n_fields,oymd,stcmp,outyears
...
*----------------------------------------------------------------------*
      ...
      INTEGER otagsnft(douts),i,j,ii,n_fields,stcmp,oymdft
